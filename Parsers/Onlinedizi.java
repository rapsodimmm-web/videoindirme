...
import com.swenauk.mainmenu.GetsPack.GetOnlinedizi;
import com.swenauk.seyirturk.R;
import java.util.Map;

/* loaded from: classes3.dex */
public class Onlinedizi extends Parsers {
    public boolean isAlt;
    public String mainUrl;
    public String oneLinkWonder;
    public String parsed;

    public Onlinedizi(String str, Context context, ExoPlayer exoPlayer) {
    ...
    protected void parse(String str) {
        this.isAlt = true;
        this.oneLinkWonder = "";
        new GetOnlinedizi(this).execute(str);
    }
    ...
    public void showAlternates(final Map<String, String> map) {
        if (!((Activity) this.calledContext).isDestroyed()) {
            if (map.size() > 1) {
                ...
                builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: com.swenauk.mainmenu.Parsers.Onlinedizi.1
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int r4) {
                        Onlinedizi.this.mainUrl = (String) map.get(charSequenceArr[r4]);
                        Onlinedizi.this.isAlt = false;
                        new GetOnlinedizi(Onlinedizi.this).execute(Onlinedizi.this.mainUrl);
                    }
                });
                ...
                if (this.oneLinkWonder.contains("closeload")) {
                    ...
                    new GetOnlinedizi(this).execute(this.oneLinkWonder);
                }
            }
        }
        this.isAlt = false;
    ...
    protected void showVideo() {
        if ((this.streamUrl.contains(".mp4") || this.streamUrl.contains(".ts")) && !this.streamUrl.contains(".m3u8")) {
            if (this.streamUrl.contains("yandex.ru")) {
                ...
                this.mediaSource = new ProgressiveMediaSource.Factory(new DataSource.Factory() { // from class: com.swenauk.mainmenu.Parsers.Onlinedizi.2
                    ...
                    public DataSource createDataSource() {
                        ...
                        if (Onlinedizi.this.streamUrl.contains("molyusercontent")) {
                            defaultHttpDataSource.setRequestProperty("Referer", Onlinedizi.this.videoUri.getScheme() + "://" + Onlinedizi.this.videoUri.getHost());
                        } else {
                            defaultHttpDataSource.setRequestProperty("Referer", Onlinedizi.this.videoUri.getScheme() + "://" + Onlinedizi.this.videoUri.getHost());
                        }
            ...
            this.mediaSource = new HlsMediaSource.Factory(new DataSource.Factory() { // from class: com.swenauk.mainmenu.Parsers.Onlinedizi.3
                @Override // com.google.android.exoplayer2.upstream.DataSource.Factory
                public DataSource createDataSource() {
                    DefaultHttpDataSource defaultHttpDataSource = new DefaultHttpDataSource("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36");
                    String str = Onlinedizi.this.videoUri.getScheme() + "://" + Onlinedizi.this.videoUri.getHost();
                    if (Onlinedizi.this.streamUrl.contains("molystream")) {
                        str = Onlinedizi.this.videoUri.getScheme() + "://" + Onlinedizi.this.videoUri.getHost();
                    }
    ...
    private void createAlertWItems(String str) {
        ...
        builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: com.swenauk.mainmenu.Parsers.Onlinedizi.4
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int r4) {
                Onlinedizi.this.showBuffer();
                System.out.println(Onlinedizi.this.streamUrls.get(charSequenceArr[r4]));
                Onlinedizi onlinedizi = Onlinedizi.this;
                onlinedizi.videoUri = Uri.parse(onlinedizi.streamUrls.get(charSequenceArr[r4]));
                DefaultDataSourceFactory defaultDataSourceFactory = new DefaultDataSourceFactory(Onlinedizi.this.calledContext, Util.getUserAgent(Onlinedizi.this.calledContext, "iFrame"));
                Onlinedizi.this.mediaSource = new ProgressiveMediaSource.Factory(defaultDataSourceFactory).createMediaSource(MediaItem.fromUri(Onlinedizi.this.videoUri));
                Onlinedizi.this.playVideo();
            }
        });
        this.alert = builder.create();
        this.alert.show();
    ...
    public void loadFilmakinesi() {
        new Onlinedizi(this.mainUrl, this.calledContext, this.player);
    }
