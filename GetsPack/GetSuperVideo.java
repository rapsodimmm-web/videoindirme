...
public class GetSuperVideo extends AsyncTask<String, String, String> {
    SuperVideo afaki;
    String res;

    public GetSuperVideo(SuperVideo superVideo) {
        this.afaki = superVideo;
    }
    ...
    private String getUrlContent(String str) {
        try {
            ...
            httpURLConnection.setRequestProperty("Referer", "http://filmakinesi.net");
    ...
    public void onPostExecute(String str) {
        super.onPostExecute((GetSuperVideo) str);
