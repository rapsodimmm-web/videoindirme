...
public class GetFoxPlay extends AsyncTask<String, String, String> {
    FoxPlay afaki;
    String res;

    public GetFoxPlay(FoxPlay foxPlay) {
        this.afaki = foxPlay;
    }
    ...
    private String getUrlContent(String str) {
        try {
            TrustManager[] trustManagerArr = {new X509TrustManager() { // from class: com.swenauk.mainmenu.GetsPack.GetFoxPlay.1
    ...
    public void onPostExecute(String str) {
        super.onPostExecute((GetFoxPlay) str);
