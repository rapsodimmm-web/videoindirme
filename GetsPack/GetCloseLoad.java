...
public class GetCloseLoad extends AsyncTask<String, String, String> {
    CloseLoad afaki;
    String res;

    public GetCloseLoad(CloseLoad closeLoad) {
        this.afaki = closeLoad;
    }
    ...
    private String getUrlContent(String str) {
        try {
            ...
            httpURLConnection.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:63.0) Gecko/20100101 Firefox/63.0");
    ...
    public void onPostExecute(String str) {
        super.onPostExecute((GetCloseLoad) str);
