...
public class GetFileRuFirst extends AsyncTask<String, String, String> {
    FileRU afaki;
    String res;

    public GetFileRuFirst(FileRU fileRU) {
        this.afaki = fileRU;
    }
    ...
    private String getUrlContent(String str) {
        try {
            ...
            httpURLConnection.setRequestProperty("Referer", "https://dizilla.com");
    ...
    public void onPostExecute(String str) {
        super.onPostExecute((GetFileRuFirst) str);
